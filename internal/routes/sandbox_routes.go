...
func RegisterSandboxRoutes(r chi.Router, template *controllers.SandboxController, session *controllers.SandboxInstanceHandler) {
	...
	r.Route("/sandbox/instance", func(r chi.Router) {
